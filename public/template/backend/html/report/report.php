        ...
        <?php if($is_system || $is_admin || $is_sales){?>
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="<?php echo $this->url('routeReport/default', array('controller' => 'index', 'action' => 'index', 'id' => 'sale', 'code' => 'share'));?>"><i class="fa fa-dot-circle-o"></i> Báo cáo nhậ số - Tỉ lệ chốt</a>
                    </li>
<!--                    <li>-->
